...
// Example
// check is something is odd or even % 2
...
// Only change code below this line
var lastLetterOfLastName = lastName[lastName.length - 6]; // Change this line
...
// Setup
var myArray = [["John", 23], ["dog", 3]];
// shift removes ["John, 23"]
myArray.shift();

// Only change code below this line
// unshift adds ["Paul", 35]
...
// call or invoke functionName
functionName();
// You can call or invoke this function by using its name followed by parentheses, like this:  Each time the function is called it will print out the message "Hello World" on the dev console. All of the code between the curly braces will be executed every time the function is called.
...
function functionWithArgs(apple, banana) {
...
console.log('we skipped bye bye');
...
checkObj(person, 'name')
 ...
 // If prop is tracks but the album doesn't have a tracks property, create an empty array and add value to it.
    else if(prop === "tracks" && !obj[id].hasOwnProperty('tracks')){
      obj[id][prop] = [value];
    }
 ...
 // If value is an empty string, delete the given prop property from the album.
  ...
  updateRecords(collection, 5439, 'tracks', 'track one');
  updateRecords(collection, 5439, 'tracks', 'track two');
