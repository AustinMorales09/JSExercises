...
function functionWithArgs(placeholder1, placeholder2){
    console.log(placeholder1 + placeholder2);
}
functionWithArgs(9,9)
...
function myLocalScope() {
    ...
    // Only change code below this line
    // myVar is local to myLocalScope function
  var myVar = 'austin';
